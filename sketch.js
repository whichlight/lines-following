...
function setup() {
    ...
    window.addEventListener('touchend',intro);
    window.addEventListener('mouseup',intro);

}

var intro = function(){
    var i = document.getElementById('info');
    window.removeEventListener('touchend',intro);
    window.removeEventListener('mouseup',intro);
